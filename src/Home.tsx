...
const NFT = styled(Paper)`
  ...
  background: url("img/minting-box.png");
    ...
    return (
        <main>
            <MainContainer>
                ...
                <br />
                <div className="row" style={{ justifyContent: 'space-between' }}>
                    <img src="img/minting-block.png" alt="..." />
                    <MintContainer>
                        <DesContainer>
                            <h2>THE SCARY TEACHER NFT PRE-SALE</h2>
                            ...
                            <NFT elevation={3}>
                                ...
                                <div className="row" style={{ justifyContent: 'center' }}>
                                    ...
                                    <div style={{marginLeft: '10px'}}>
                                        ...
                                        {wallet && isActive &&
                                            <div><h3>TOTAL MINTED : {itemsRedeemed} / {itemsAvailable}</h3></div>}
                                    </div>
                                </div>
